...
// DELETE
const deleteSingleIngredient = (id) =>
  new Promise((resolve, reject) => {
    fetch(`${endpoint}/ingredients/${id}.json`, {
      method: 'DELETE',
      headers: {
...
export { getIngredients, createIngredient, getSingleIngredient, deleteSingleIngredient, updateIngredient };
